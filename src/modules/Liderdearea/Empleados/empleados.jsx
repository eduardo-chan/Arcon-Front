...
const userAreaId = user.usuario.area.id;
...
console.log("areaId", areaId)
  ...
  const getUsuarios = async () => {
    try {
      ...
      if (!data.error) {
        // Filtrar usuarios por área y rol
        const usuariosFiltrados = data.data.filter(usuario => usuario.area.id === userAreaId && usuario.role.name === "empleado");
