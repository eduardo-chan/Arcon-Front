...
import ArchivosEdt from "../Archivos/components/ArchivosEdt";
...
function Archivos() {
    ...
    const handleSearch = () => {
      ...
      // En el useEffect que filtra por área y usuario
      useEffect(() => {
    ...
    const eliminarArchivo = (id) => {
        AxiosClientWithoutInterceptors.delete(`/archive/?id=${id}`)
            .then((response) => {
                ...
                window.location.reload(); // Recargar la página después de eliminar el archivo
            })
            .catch((error) => {
        ...
        <>
            <div className="container">
                ...
                <div className="buscararchivos">
                    ...
                    <ArchivosEdt show={editModalShow} handleClose={handleEditModalClose} archivoSeleccionado={archivoSeleccionado} />
                </div>
            </div >
        </>
    );
